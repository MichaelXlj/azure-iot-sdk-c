...
static void set_expected_calls_send_http_workload_request(bool expect_success, bool post_data)
{
    ...
    STRICT_EXPECTED_CALL(STRING_c_str(IGNORED_PTR_ARG)).SetReturn(post_data ? TEST_STRING_1 : NULL);
...
static void set_expected_calls_hsm_client_http_edge_get_trusted_certificates()
{
...
TEST_FUNCTION(hsm_client_http_edge_get_trusted_certificates_success)
{
    setup_hsm_client_http_edge_create_mock(TEST_ENV_WORKLOADURI, true);
    ...
    set_expected_calls_hsm_client_http_edge_get_trusted_certificates();
    printf("Expected:: %s\n", umockcallrecorder_get_expected_calls(umock_c_get_call_recorder()));

    const char* trusted_certificate = hsm_client_http_edge_get_trusted_certificates(sec_handle);
    ASSERT_IS_NOT_NULL_WITH_MSG(trusted_certificate, "hsm_client_http_edge_get_trusted_certificates fails");
    ASSERT_ARE_EQUAL(char_ptr, umock_c_get_expected_calls(), umock_c_get_actual_calls());
...
TEST_FUNCTION(hsm_client_http_edge_get_trusted_certificates_NULL_sec_handle_fail)
{
    setup_hsm_client_http_edge_create_mock(TEST_ENV_WORKLOADURI, true);
    ...
    const char* trusted_certificate = hsm_client_http_edge_get_trusted_certificates(NULL);
...
TEST_FUNCTION(hsm_client_http_edge_get_trusted_certificates_fail)
{
    // arrange
    int negativeTestsInitResult = umock_c_negative_tests_init();
    ASSERT_ARE_EQUAL(int, 0, negativeTestsInitResult);
    ...
    size_t calls_cannot_fail[] = {
        0, // socketio_get_interface_description
        3, // STRING_c_str
        4, // STRING_c_str
        5, // get_time
    ...
    for (size_t index = 0; index < count; index++)
    {
        ...
        char tmp_msg[128];
        sprintf(tmp_msg, "hsm_client_http_edge_get_trusted_certificates failure in test %zu/%zu", index, count);
        const char* trusted_certificate = hsm_client_http_edge_get_trusted_certificates(sec_handle);
